...
class Business(Model):
    ...
    owner = fields.ForeignKeyField("models.user", related="business")
...
class Product(Model):
    ...
    product_image = fields.CharField(max_length=200, null=False, default='ProductProfile.jpg')
    business = fields.ForeignKeyField("models.Business", related_name="Products")
    
    
user_pydantic = pydantic_model_creator(User, name="User", exclude=("is_verified",)) 
user_pydanticIn = pydantic_model_creator(User, name="UserIn", exclude=("is_verified", "join_date"), exclude_readonly=True) 
